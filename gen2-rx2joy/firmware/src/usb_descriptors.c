 ...
 *
 * gen2: cambia el nombre de producto, nada mas. El formato del reporte,
 * el VID/PID y el numero de serie se mantienen a proposito. Windows
 * indexa la calibracion del panel de mandos y VRC Pro el mapeo de ejes
 * por VID/PID/serie: tocar cualquiera de los tres obligaria a remapear
 * todo desde cero al pasar del v1 a este firmware.
 */
...
uint8_t const desc_configuration[] = {
    /* 250 mA: receptor (~50) + OLED (~20) + RP2040 (~30) ya no entran
...
char const *string_desc_arr[] = {
    ...
    "DIY",                          /* 1: fabricante      */
    "RX2JOY Surface RC Sim",        /* 2: producto        */
    "000001",                       /* 3: serie           */
    "RX2JOY Consola",               /* 4: interfaz CDC    */
};
